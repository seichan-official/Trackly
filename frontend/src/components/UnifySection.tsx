...
export default function UnifySection(){
  return(
<section className="min-h-screen flex flex-col md:flex-row items-center md:items-center justify-between px-10 md:px-20  py-20">
  ...
  <div className="flex-1 space-y-8 md:pr-10">
      ...
      <SlideSubTitle delay={0.3}>
        <p className="text-2xl md:text-xl text-gray-600 leading-relaxed">
  ...
  <div className="flex-1 flex justify-center md:justify-end mt-10 md:mt-0">
      <img src="/image/up.jpg" alt="up" className="w-[260px] sm:w-[350px] md:w-[450px] lg:w-[550px]"/>
  </div>
